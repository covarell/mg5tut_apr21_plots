...
def analyze(valu):
    ...
    lhe_file = '/afs/cern.ch/user/c/covarell/work/mg5_amcatnlo/dim8-hh/MG5_aMC_v2_7_3_py3/lambda-results/Events/runlambda-' + valu + '_cutshistat/unweighted_events.lhe'     
    ...
    for event in reader:
        ...
        outfile = './fractions_lambda_' + valu + '.json'
